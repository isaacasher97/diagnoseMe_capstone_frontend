<template>
<div id="cardContainer" class="card mb-3" style="max-width: 90%; margin: 0 auto;">
  <div class="row g-0">
    <div class="col-md-4">
      <img style="width: 100%" src="../../public/imgs/newStethoscope.png" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
